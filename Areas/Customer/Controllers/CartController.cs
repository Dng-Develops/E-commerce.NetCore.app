...
namespace E_commerce_app.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private Payment PaymentProcess(ShoppingCartVM model)
        {
            ...
            options.ApiKey = "Your Api key goes here";
            ...
            buyer.RegistrationAddress = model.OrderHeader.Adrdess;
            ...
            foreach (var item in _db.ShoppingCarts.Where(i => i.ApplicationUserId == claim.Value).Include(i=> i.Product)) // Get products from users shopping cart and iterate
            {
